...
init_help_array(void)
{
  ...
  bppPipeline_args_info_help[16] = bppPipeline_args_info_detailed_help[24];
  bppPipeline_args_info_help[17] = bppPipeline_args_info_detailed_help[25];
  bppPipeline_args_info_help[18] = 0; 
  
}

const char *bppPipeline_args_info_help[19];
...
void init_args_info(struct bppPipeline_args_info *args_info)
{
  ...
  args_info->seq_windows_help = bppPipeline_args_info_detailed_help[22] ;
  args_info->bin_help = bppPipeline_args_info_detailed_help[24] ;
  args_info->frq_help = bppPipeline_args_info_detailed_help[25] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVi:b:o:k:d:w::", long_options, &option_index);
