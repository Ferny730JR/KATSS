/*
  ...
  gengetopt --input=bppPipeline.ggo --file-name=bppPipeline_cmdl --include-getopt --default-optional --unamed-opts --func-name=bppPipeline_cmdline_parser --arg-struct-name=bppPipeline_args_info
...
const char *bppPipeline_args_info_purpose = "A method for finding the average base-pair probability of all kmers in a\nprotein";

const char *bppPipeline_args_info_usage = "Usage: bppPipeline [OPTIONS] [<input.fa>] [<bound.fa>]";

const char *bppPipeline_args_info_versiontext = "";
...
const char *bppPipeline_args_info_detailed_help[] = {
  ...
  "  The output of the BPP Pipeline by default is in csv format, meaning the\n  values are comma delimited. By specifying this option, you can change the\n  delimiter used to separate the values. The available delimiters are: comma\n  (,), tab ('t'), colon (:), vertical bar (|), and space (\" \") For example,\n  setting `--file-delimiter=\" \"' will change the delimiter to be space\n  separated. Support for other delimiters is currently unavailable.\n",
...
{
  bppPipeline_args_info_help[0] = bppPipeline_args_info_detailed_help[0];
  ...
  bppPipeline_args_info_help[10] = bppPipeline_args_info_detailed_help[15];
  ...
  bppPipeline_args_info_help[13] = bppPipeline_args_info_detailed_help[20];
  bppPipeline_args_info_help[14] = bppPipeline_args_info_detailed_help[21];
  ...
  bppPipeline_args_info_help[17] = bppPipeline_args_info_detailed_help[25];
  bppPipeline_args_info_help[18] = bppPipeline_args_info_detailed_help[26];
  bppPipeline_args_info_help[19] = 0; 
  
}

const char *bppPipeline_args_info_help[20];

typedef enum {ARG_NO
  , ARG_FLAG
  , ARG_STRING
  , ARG_INT
} bppPipeline_cmdline_parser_arg_type;

static
void clear_given (struct bppPipeline_args_info *args_info);
static
void clear_args (struct bppPipeline_args_info *args_info);

static int
bppPipeline_cmdline_parser_internal (int argc, char **argv, struct bppPipeline_args_info *args_info,
                        struct bppPipeline_cmdline_parser_params *params, const char *additional_error);
...
void clear_args (struct bppPipeline_args_info *args_info)
{
  ...
  args_info->frq_flag = 0;
  
}

static
void init_args_info(struct bppPipeline_args_info *args_info)
{
  ...
  args_info->file_delimiter_help = bppPipeline_args_info_detailed_help[13] ;
  args_info->keepFolds_help = bppPipeline_args_info_detailed_help[15] ;
  args_info->input_fold_help = bppPipeline_args_info_detailed_help[16] ;
  args_info->bound_fold_help = bppPipeline_args_info_detailed_help[18] ;
  args_info->jobs_help = bppPipeline_args_info_detailed_help[20] ;
  args_info->seq_windows_help = bppPipeline_args_info_detailed_help[23] ;
  args_info->bin_help = bppPipeline_args_info_detailed_help[25] ;
  args_info->frq_help = bppPipeline_args_info_detailed_help[26] ;
  
}

void
bppPipeline_cmdline_parser_print_version (void)
{
  printf ("%s %s\n",
     (strlen(BPPPIPELINE_CMDLINE_PARSER_PACKAGE_NAME) ? BPPPIPELINE_CMDLINE_PARSER_PACKAGE_NAME : BPPPIPELINE_CMDLINE_PARSER_PACKAGE),
     BPPPIPELINE_CMDLINE_PARSER_VERSION);

  if (strlen(bppPipeline_args_info_versiontext) > 0)
    printf("\n%s\n", bppPipeline_args_info_versiontext);
}

static void print_help_common(void)
{
	size_t len_purpose = strlen(bppPipeline_args_info_purpose);
	size_t len_usage = strlen(bppPipeline_args_info_usage);

	if (len_usage > 0) {
		printf("%s\n", bppPipeline_args_info_usage);
	}
	if (len_purpose > 0) {
		printf("%s\n", bppPipeline_args_info_purpose);
	}
	...
	if (strlen(bppPipeline_args_info_description) > 0) {
		printf("%s\n\n", bppPipeline_args_info_description);
	}
}

void
bppPipeline_cmdline_parser_print_help (void)
{
  int i = 0;
  print_help_common();
  while (bppPipeline_args_info_help[i])
    printf("%s\n", bppPipeline_args_info_help[i++]);
}

void
bppPipeline_cmdline_parser_print_detailed_help (void)
{
  int i = 0;
  print_help_common();
  while (bppPipeline_args_info_detailed_help[i])
    printf("%s\n", bppPipeline_args_info_detailed_help[i++]);
}

void
bppPipeline_cmdline_parser_init (struct bppPipeline_args_info *args_info)
{
...
void
bppPipeline_cmdline_parser_params_init(struct bppPipeline_cmdline_parser_params *params)
{
  if (params)
    { 
      params->override = 0;
...
struct bppPipeline_cmdline_parser_params *
bppPipeline_cmdline_parser_params_create(void)
{
  struct bppPipeline_cmdline_parser_params *params = 
    (struct bppPipeline_cmdline_parser_params *)malloc(sizeof(struct bppPipeline_cmdline_parser_params));
  bppPipeline_cmdline_parser_params_init(params);  
  return params;
}
...
static void
bppPipeline_cmdline_parser_release (struct bppPipeline_args_info *args_info)
{
  unsigned int i;
...
int
bppPipeline_cmdline_parser_dump(FILE *outfile, struct bppPipeline_args_info *args_info)
{
  int i = 0;

  if (!outfile)
    {
      fprintf (stderr, "%s: cannot dump options to stream\n", BPPPIPELINE_CMDLINE_PARSER_PACKAGE);
      return EXIT_FAILURE;
    }
  ...
  if (args_info->frq_given)
    write_into_file(outfile, "frq", 0, 0 );
...
int
bppPipeline_cmdline_parser_file_save(const char *filename, struct bppPipeline_args_info *args_info)
{
  FILE *outfile;
  int i = 0;
  ...
  if (!outfile)
    {
      fprintf (stderr, "%s: cannot open file for writing: %s\n", BPPPIPELINE_CMDLINE_PARSER_PACKAGE, filename);
      return EXIT_FAILURE;
    }

  i = bppPipeline_cmdline_parser_dump(outfile, args_info);
  fclose (outfile);
...
void
bppPipeline_cmdline_parser_free (struct bppPipeline_args_info *args_info)
{
  bppPipeline_cmdline_parser_release (args_info);
}
...
int
bppPipeline_cmdline_parser (int argc, char **argv, struct bppPipeline_args_info *args_info)
{
  return bppPipeline_cmdline_parser2 (argc, argv, args_info, 0, 1, 1);
}

int
bppPipeline_cmdline_parser_ext (int argc, char **argv, struct bppPipeline_args_info *args_info,
                   struct bppPipeline_cmdline_parser_params *params)
{
  int result;
  result = bppPipeline_cmdline_parser_internal (argc, argv, args_info, params, 0);
...
int
bppPipeline_cmdline_parser2 (int argc, char **argv, struct bppPipeline_args_info *args_info, int override, int initialize, int check_required)
{
  int result;
  struct bppPipeline_cmdline_parser_params params;
...
int
bppPipeline_cmdline_parser_required (struct bppPipeline_args_info *args_info, const char *prog_name)
{
  FIX_UNUSED (args_info);
 ...
 * @param check_ambiguity @see bppPipeline_cmdline_parser_params.check_ambiguity
 * @param override @see bppPipeline_cmdline_parser_params.override
...
int update_arg(void *field, char **orig_field,
               ...
               bppPipeline_cmdline_parser_arg_type arg_type,
...
int
bppPipeline_cmdline_parser_internal (
  int argc, char **argv, struct bppPipeline_args_info *args_info,
                        struct bppPipeline_cmdline_parser_params *params, const char *additional_error)
{
  int c;	/* Character of the parsed option.  */

  int error_occurred = 0;
  struct bppPipeline_args_info local_args_info;
  ...
  if (initialize)
    bppPipeline_cmdline_parser_init (args_info);

  bppPipeline_cmdline_parser_init (&local_args_info);
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVi:b:o:k:d:j::w::", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'h':	/* Print help and exit.  */
          bppPipeline_cmdline_parser_print_help ();
          bppPipeline_cmdline_parser_free (&local_args_info);
          exit (EXIT_SUCCESS);

        case 'V':	/* Print version and exit.  */
          bppPipeline_cmdline_parser_print_version ();
          bppPipeline_cmdline_parser_free (&local_args_info);
          exit (EXIT_SUCCESS);
...
.  */
          ...
          if (update_arg( (void *)&(args_info->kmer_arg), 
              ...
              &(local_args_info.kmer_given), optarg, 0, "3", ARG_INT,
              check_ambiguity, override, 0, 0,
              "kmer", 'k',
              additional_error))
            goto failure;
...
.  */
          ...
          break;
        case 'w':	/* Split the sequence into sliding windows of the specified size and find the mean probability per position in the window.
.  */
        
        
          if (update_arg( (void *)&(args_info->seq_windows_arg), 
               &(args_info->seq_windows_orig), &(args_info->seq_windows_given),
              &(local_args_info.seq_windows_given), optarg, 0, "20", ARG_INT,
              check_ambiguity, override, 0, 0,
              "seq-windows", 'w',
              additional_error))
            goto failure;
        ...
        case 0:	/* Long option with no short option */
          if (strcmp (long_options[option_index].name, "detailed-help") == 0) {
            bppPipeline_cmdline_parser_print_detailed_help ();
            bppPipeline_cmdline_parser_free (&local_args_info);
            exit (EXIT_SUCCESS);
          }
...
.  */
          else if (strcmp (long_options[option_index].name, "bin") == 0)
          {
            ...
            if (update_arg((void *)&(args_info->bin_flag), 0, &(args_info->bin_given),
                ...
                check_ambiguity, override, 1, 0, "bin", '-',
                additional_error))
              goto failure;
...
.  */
          else if (strcmp (long_options[option_index].name, "frq") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->frq_flag), 0, &(args_info->frq_given),
                &(local_args_info.frq_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "frq", '-',
                additional_error))
              goto failure;
        ...
        default:	/* bug: option not considered.  */
          fprintf (stderr, "%s: option unknown: %c%s\n", BPPPIPELINE_CMDLINE_PARSER_PACKAGE, c, (additional_error ? additional_error : ""));
          abort ();
        } /* switch */
    } /* while */
  ...
  bppPipeline_cmdline_parser_release (&local_args_info);
