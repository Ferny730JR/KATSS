/*
  ...
  gengetopt --input=aspiire.ggo --file-name=aspiire_cmdl --include-getopt --default-optional --unamed-opts --func-name=aspiire_cmdline_parser --arg-struct-name=aspiire_args_info
...
const char *aspiire_args_info_purpose = "IRE discovery tool";

const char *aspiire_args_info_usage = "Usage: ASPIIRE [OPTIONS] [<feature_annotations.txt>]";
...
{
  aspiire_args_info_help[0] = aspiire_args_info_detailed_help[0];
  aspiire_args_info_help[1] = aspiire_args_info_detailed_help[1];
  aspiire_args_info_help[2] = aspiire_args_info_detailed_help[2];
  aspiire_args_info_help[3] = aspiire_args_info_detailed_help[3];
  aspiire_args_info_help[4] = aspiire_args_info_detailed_help[4];
  aspiire_args_info_help[5] = aspiire_args_info_detailed_help[5];
  aspiire_args_info_help[6] = aspiire_args_info_detailed_help[7];
  aspiire_args_info_help[7] = aspiire_args_info_detailed_help[9];
  aspiire_args_info_help[8] = aspiire_args_info_detailed_help[11];
...
static
void clear_given (struct aspiire_args_info *args_info);
static
void clear_args (struct aspiire_args_info *args_info);

static int
aspiire_cmdline_parser_internal (int argc, char **argv, struct aspiire_args_info *args_info,
                        struct aspiire_cmdline_parser_params *params, const char *additional_error);
...
static
void init_args_info(struct aspiire_args_info *args_info)
{

  init_help_array(); 
  args_info->help_help = aspiire_args_info_detailed_help[0] ;
  args_info->detailed_help_help = aspiire_args_info_detailed_help[1] ;
  args_info->version_help = aspiire_args_info_detailed_help[2] ;
  args_info->input_help = aspiire_args_info_detailed_help[5] ;
  args_info->output_help = aspiire_args_info_detailed_help[7] ;
  args_info->kmer_help = aspiire_args_info_detailed_help[9] ;
  args_info->threshold_help = aspiire_args_info_detailed_help[11] ;
...
void
aspiire_cmdline_parser_print_version (void)
{
  printf ("%s %s\n",
     (strlen(ASPIIRE_CMDLINE_PARSER_PACKAGE_NAME) ? ASPIIRE_CMDLINE_PARSER_PACKAGE_NAME : ASPIIRE_CMDLINE_PARSER_PACKAGE),
     ASPIIRE_CMDLINE_PARSER_VERSION);

  if (strlen(aspiire_args_info_versiontext) > 0)
    printf("\n%s\n", aspiire_args_info_versiontext);
}

static void print_help_common(void)
{
	size_t len_purpose = strlen(aspiire_args_info_purpose);
	size_t len_usage = strlen(aspiire_args_info_usage);

	if (len_usage > 0) {
		printf("%s\n", aspiire_args_info_usage);
	}
	if (len_purpose > 0) {
		printf("%s\n", aspiire_args_info_purpose);
	}
	...
	if (strlen(aspiire_args_info_description) > 0) {
		printf("%s\n\n", aspiire_args_info_description);
	}
}

void
aspiire_cmdline_parser_print_help (void)
{
  int i = 0;
  print_help_common();
  while (aspiire_args_info_help[i])
    printf("%s\n", aspiire_args_info_help[i++]);
}

void
aspiire_cmdline_parser_print_detailed_help (void)
{
  int i = 0;
  print_help_common();
  while (aspiire_args_info_detailed_help[i])
    printf("%s\n", aspiire_args_info_detailed_help[i++]);
}

void
aspiire_cmdline_parser_init (struct aspiire_args_info *args_info)
{
...
void
aspiire_cmdline_parser_params_init(struct aspiire_cmdline_parser_params *params)
{
  if (params)
    { 
      params->override = 0;
...
aspiire_cmdline_parser_params_create(void)
{
  struct aspiire_cmdline_parser_params *params = 
    (struct aspiire_cmdline_parser_params *)malloc(sizeof(struct aspiire_cmdline_parser_params));
  aspiire_cmdline_parser_params_init(params);  
  return params;
}
...
static void
aspiire_cmdline_parser_release (struct aspiire_args_info *args_info)
{
  unsigned int i;
...
int
aspiire_cmdline_parser_dump(FILE *outfile, struct aspiire_args_info *args_info)
{
  int i = 0;

  if (!outfile)
    {
      fprintf (stderr, "%s: cannot dump options to stream\n", ASPIIRE_CMDLINE_PARSER_PACKAGE);
      return EXIT_FAILURE;
    }
...
int
aspiire_cmdline_parser_file_save(const char *filename, struct aspiire_args_info *args_info)
{
  FILE *outfile;
  int i = 0;
  ...
  if (!outfile)
    {
      fprintf (stderr, "%s: cannot open file for writing: %s\n", ASPIIRE_CMDLINE_PARSER_PACKAGE, filename);
      return EXIT_FAILURE;
    }

  i = aspiire_cmdline_parser_dump(outfile, args_info);
  fclose (outfile);
...
void
aspiire_cmdline_parser_free (struct aspiire_args_info *args_info)
{
  aspiire_cmdline_parser_release (args_info);
}
...
int
aspiire_cmdline_parser (int argc, char **argv, struct aspiire_args_info *args_info)
{
  return aspiire_cmdline_parser2 (argc, argv, args_info, 0, 1, 1);
}

int
aspiire_cmdline_parser_ext (int argc, char **argv, struct aspiire_args_info *args_info,
                   struct aspiire_cmdline_parser_params *params)
{
  int result;
  result = aspiire_cmdline_parser_internal (argc, argv, args_info, params, 0);
...
int
aspiire_cmdline_parser2 (int argc, char **argv, struct aspiire_args_info *args_info, int override, int initialize, int check_required)
{
  int result;
  struct aspiire_cmdline_parser_params params;
...
int
aspiire_cmdline_parser_required (struct aspiire_args_info *args_info, const char *prog_name)
{
  FIX_UNUSED (args_info);
 ...
 * @param check_ambiguity @see aspiire_cmdline_parser_params.check_ambiguity
 * @param override @see aspiire_cmdline_parser_params.override
...
int update_arg(void *field, char **orig_field,
               ...
               aspiire_cmdline_parser_arg_type arg_type,
...
int
aspiire_cmdline_parser_internal (
  int argc, char **argv, struct aspiire_args_info *args_info,
                        struct aspiire_cmdline_parser_params *params, const char *additional_error)
{
  int c;	/* Character of the parsed option.  */

  int error_occurred = 0;
  struct aspiire_args_info local_args_info;
  ...
  if (initialize)
    aspiire_cmdline_parser_init (args_info);

  aspiire_cmdline_parser_init (&local_args_info);
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'h':	/* Print help and exit.  */
          aspiire_cmdline_parser_print_help ();
          aspiire_cmdline_parser_free (&local_args_info);
          exit (EXIT_SUCCESS);

        case 'V':	/* Print version and exit.  */
          aspiire_cmdline_parser_print_version ();
          aspiire_cmdline_parser_free (&local_args_info);
          exit (EXIT_SUCCESS);
...
.  */
          ...
          if (update_arg( (void *)&(args_info->kmer_arg), 
              ...
              &(local_args_info.kmer_given), optarg, 0, "30", ARG_INT,
              check_ambiguity, override, 0, 0,
              "kmer", 'k',
              additional_error))
            goto failure;
          ...
          break;
        case 't':	/* Specify the minimum percent match that predicted structure should match RNAfold structure.
.  */
...
.  */
        ...
        case 0:	/* Long option with no short option */
          if (strcmp (long_options[option_index].name, "detailed-help") == 0) {
            aspiire_cmdline_parser_print_detailed_help ();
            aspiire_cmdline_parser_free (&local_args_info);
            exit (EXIT_SUCCESS);
          }
...
.  */
          if (strcmp (long_options[option_index].name, "format") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->format_arg), 
                ...
                &(local_args_info.format_given), optarg, 0, "seq", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "format", '-',
                additional_error))
              goto failure;
...
.  */
          else if (strcmp (long_options[option_index].name, "no-rnafold") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->no_rnafold_flag), 0, &(args_info->no_rnafold_given),
                &(local_args_info.no_rnafold_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "no-rnafold", '-',
                additional_error))
              goto failure;
        ...
        default:	/* bug: option not considered.  */
          fprintf (stderr, "%s: option unknown: %c%s\n", ASPIIRE_CMDLINE_PARSER_PACKAGE, c, (additional_error ? additional_error : ""));
          abort ();
        } /* switch */
    } /* while */
  ...
  aspiire_cmdline_parser_release (&local_args_info);
